...
export default function AboutPage() {
  return (
    ...
    >
      ...
      <Block
        kicker="הסיפור"
        title="מייסד אחד, רשת שותפים, מטרה אחת."
        body="Kontrol נוסדה על ידי קאל מתוך זווית פשוטה: מה שעובד במוסכים גדולים לא חייב להיות מוסתר מלקוחות פרטיים. הטכנולוגיה והכמויות פתחו פתח לתמחור שנגיש לכולם — דרך רשת של מוסכי פרימיום שבחרנו לעבוד איתם."
      />
